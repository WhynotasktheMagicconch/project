 ...
 this.showMessageBox=function(wTitle,content,pos,wWidth)
	{
	   ...
	   var mesWindowCss="border:#ccc "+this.MsgBorder+"px solid;background:"+this.BgColor+";" //弹窗边框
	  ...
	  // }
	   ...
	   if (this.QuoteByAdmin==true){
		   ...
		   if (this.ShowClose==true){
			mesW.innerHTML="<div style='border-bottom:#eee 1px solid;padding:3px;font-weight:bold;text-align:left;font-size:12px;"+this.TitleCss+"'><table cellpadding='0' cellspacing='0' width='100%' height='100%'><tr><td><b><font color=#ff6600>"+wTitle+"</font></b></td><td style='width:41px;'><a href='javascript:closeWindow();' style='color:#ff6600'>X关闭</a></td></tr></table></div><div style='font-size:12px;' id='mesWindowContent'>"+content+"</div><div class='mesWindowBottom'></div>";
		   }else{
