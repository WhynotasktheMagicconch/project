/*================================================================
Copyright:www.newmotor.com.cn
==================================================================*/

var installdir='/';           //系统安装目录，请正确填写。如安装在根目录下，请设为 installdir='/kesion/'
installdir='http://www.newmotor.com.cn/';
function LabelAjax()
{
		  ...
		  if (obj.id.substring(0,2)=="ks")
		   {
			  ...
			  try{  
			  getlabelcontent("plus/ajax.shtml",obj,labelid,"Label",typeid,channelid,classid,infoid)
			   }catch(e){}
		   }
		   else if (obj.id.substring(0,3)=="SQL")
		   {
			...
			try{getlabelcontent("plus/ajax.shtml",obj,obj.id,"SQL",0,channelid,classid,infoid);   
			 }catch(e){}
		   }
		}
  }
  ...
  try{
    ...
    ksxhr.onreadystatechange=function(){
		  if(ksxhr.readyState==1)
				  {
					obj.innerHTML="<span align='center'><img src='"+installdir+"images/loading.gif'>加载中...</span>";
				  }
				  else if(ksxhr.readyState==2 || ksxhr.readyState==3)
				  {
				   obj.innerHTML="<span align='center'><img src='"+installdir+"images/loading.gif'>读取中...</span>";
				   }
